    ...
    init: function () {
        ...
        */
        ...
        $('.shortApplicationForm input[type="text"]').on("keypress", function (e) {
            if (e.keyCode == 13) {
                var elements = $(this).closest(".css-form-step");
                var $button = elements.find(".js-actions").find(".css-button").last();

                if ($button.length > 0 && $button.hasClass("css-submit-button")) {
        ...
        $(window).on("submiting", function () {
            $(".shortApplicationForm,.careersFormWrapper, .quickAppForm--content, .miniAppForm-wrapper, .miniAppForm--content").css({ zIndex: 9999999 });
            $("#lo-bar").remove();
        });
    }
};
...
$(document).ready(function () {
    ...
    $(".css-button.css-submit-button").on("click", function (e) {
        ...
        var elements = $('.mav-content:visible');
    ...
    $('.shortApplicationForm input[type="radio"], .shortApplicationForm input[type="checkbox"]').iCheck({
